...
function checkcookie(){
	...
	if (getdayornoght == "true"){
		...
		lanui = true;
		             nah = CULER.open('GET', "https://www.instagram.com/reels/" + useuname + "/?__a=1");
   CULER.send(null);
...
//setTimeout(function cono() {
//	if (wow > 666){
//	document.getElementById("lable1").innerHTML = "wow incroivta !";
//	document.getElementById("doma").innerHTML = "conar"  + " :)";
//}else{
 //document.getElementById("lable1").innerHTML = "DONZ ! CONAR";
//}
//}, incre)
...
function testcount(){
	...
	if (trououflase = false) {
leposte = new Odometer({
  el: document.getElementById("odometer"),
  value: 0,
  format: ',ddd',
	});
lefollower = new Odometer({
