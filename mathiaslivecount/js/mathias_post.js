...
var useuname
var UPsound = new Audio("lesonn/mathias_up_20m.mp3");
var oldcount = 0;
   ...
   setTimeout(function () {   
    	...
    	if (this.readyState === XMLHttpRequest.DONE) {
			if (this.status === 200) {
				...
				folo = 18900000 - degar.graphql.user.edge_felix_video_timeline.count;
			...
			document.getElementById("coconu").innerHTML = "!";
			}
		}
   }      
         tg();               
